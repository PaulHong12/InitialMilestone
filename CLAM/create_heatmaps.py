...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(process_stack))):
        ...
        coords = coord_dset[:]
        file.close()
        # l=min(scores.shape[0],coords.shape[0])
        # print('ori',scores.shape[0],coords.shape[0],l)
        # print('ori',scores,coords)
        ...
        print('check2',scores,coords,save_path)
